...
#slideMenu a.toggleBtn {position:absolute; left:-440px; margin-left:300px; top:0; outline:none; display:block; height:50px; background-color:#e46f69; 
...
<?php include "config/server.php";
	...
	$sql = mysql_query("SELECT j.Urut as Urut, j.XJawaban as XJawaban, j.XJawabanEsai as XJawabanEsai , c.XNomerSoal as XNomerSoal, j.XRagu as XRagu, c.XJenisSoal as XJenisSoal 
		...
		while($s = mysql_fetch_array($sql)){		
			...
			if($s['XRagu']=='1'){$cssb = "#eaca08"; $csst = "#000"; $noti = "noti-ragu"; $border = "#eaca08"; $iki = 'R';} 
			elseif(	$s['Urut']==$_REQUEST['pic'] ){$cssb = "#336898"; $csst = "#fff"; $noti = "noti-ragu"; $border = "#336898";	$iki = 'S';}
			elseif(!$jwbsoal==''){$cssb = "#313132"; $csst = "#fff"; $noti = "noti-ragu"; $border = "#313132"; $iki = 'S';}
...
<?php include "config/server.php";
	...
	$sqluser = mysql_query("SELECT u.*,m.XNamaMapel FROM cbt_ujian u LEFT JOIN cbt_paketsoal p on p.XKodeSoal = u.XKodeSoal and p.XKodeMapel = u.XKodeMapel 
...
<script src="css/js/masonry.pkgd.min.js"></script>
	...
	<table border="0"><tr><td valign="middle" width="50px" align="center"><font size="+3" color="#FFFFFF">< </font></td><td> 	
...
$(document).keydown(function(e) { 
	  ...
	  <?php } ?>
				...
				<?php }else { ?>
				if(e.which==65||e.which==66||e.which==67) {
				<?php } ?>
...
<script type="text/javascript" src="css/js/jquery.jplayer.min.js"></script>
...
<script type="text/javascript" language="javascript" src="css/js/jquery.jfontsize-1.0.js"></script>
...
<!-- =====================================
Tampilkan Kata Perhatian sesuaikan dengan
perinta if ($putar==0) pada batas putar
pada scrip putar audio dan video
1 = sekali putar
2 = dua kali putar
3 = tidak terbatas
====================================== -->

<!-- /// Kata peringatan listening /// -->
<?php if ($putar<$listen || $putar2<$listen){
if(str_replace(" ","",$result['XAudioTanya'])!==''){
		echo "
		<div style='padding-top:10px'><font color=#fe4d4d>
		Listening Section : Selama audio berjalan tidak bisa pindah ke Soal lainnya <br>
		Refresh/reload browser (tekan F5) atau klik soal berikutnya dan soal sebelumnya untuk putar selanjutnya
		</font><br><br>"; 
} }?>
	...
	$("#jquery_jplayer_1").jPlayer({
		...
		ready: function (event) {
			$(this).jPlayer("setMedia", {
				title: "<?php echo "AudioPlayer | ".$skull ."-CBT";?>",
...
<?php if ($putar==0){?>
<script>
function myFunction(waktu) //alert("Paused");
...
function FileHabis(waktu,nomer) //alert("Ended"); 
...
<script>
function myFunction(waktu)//alert("Paused");
	{document.getElementById("filephp").innerHTML='<object type="text/html" data="simpan1_mp3.php?aksi=pause&soal=<?php echo $xkodesoal; ?>&token=<?php echo $xtokenujian; ?>&nomer=<?php echo $current_picture; ?>&waktu='+waktu+'" ></object>';}
function FileHabis(waktu,nomer)//alert("Ended"); 
	{document.getElementById("filephp").innerHTML='<object type="text/html" data="simpan1_mp3.php?aksi=habis&soal=<?php echo $xkodesoal; ?>&token=<?php echo $xtokenujian; ?>&nomer=<?php echo $current_picture; ?>&waktu='+waktu+'" ></object>';}
</script>
<?php }?>

<?php if ($putar2==0){?>
<script>
function myFunction2(waktu2) //alert("Paused");
...
function FileHabis2(waktu2,nomer) //alert("Ended");
...
<?php } else if ($putar2==1) { ?>
<script>
function myFunction2(waktu2) //alert("Paused");
     {document.getElementById("filephp").innerHTML='<object type="text/html" data="simpan1_mp4.php?aksi=pause&soal=<?php echo $xkodesoal; ?>&token=<?php echo $xtokenujian; ?>&nomer=<?php echo $current_picture; ?>&waktu='+waktu2+'" ></object>';}
function FileHabis2(waktu2,nomer) //alert("Ended");
     {document.getElementById("filephp").innerHTML='<object type="text/html" data="simpan1_mp4.php?aksi=habis&soal=<?php echo $xkodesoal; ?>&token=<?php echo $xtokenujian; ?>&nomer=<?php echo $current_picture; ?>&waktu='+waktu2+'" ></object>';}
</script>	
<?php }?>
...
<!-- ==========================================
Ganti angka 1, 2 atau 3 
($putar<1)  => ($putar<2) atau ($putar<3)
1 = putar sekali
2 = putar 2 kali
3 = tidak terbatas
=========================================== --> 
...
<!-- ==========================================
Ganti angka 1 menjadi 2 atau 3
($putar2<1)  => ($putar2<2) atau ($putar2<3)
1 = putar sekali
2 = putar 2 kali
3 = tidak terbatas
=========================================== -->
...
<table border="0" cellpadding="0px" cellspacing="0px">
	<tr><td valign="top"><input id="A" type="radio" name="credit-card" value="A" <?php echo $nilaiA; ?>>
        ...
        <?php if(str_replace("  ","",$result['XGambarJawab1'])==''){
			} else { $gambarA = "XGambarJawab".$result['XA']; $pilgbrA = "$result[$gambarA]"; 
				...
				<div class="modal-dialog" style="width:95%">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<div class="inner-content">
								<div class="row" style="background-color:#fff">
										<?php 	if(str_replace("  ","",$pilgbrA)==''){}else{
        ...
        <td class="pilihanjawaban" valign="top"><?php echo "$jwbA"; ?></td>
	</tr>
	<tr><td valign="top"><input id="B" type="radio" name="credit-card" value="B" <?php echo $nilaiB; ?>>
			<label class="drinkcard-cc B" for="B">&nbsp;</label>
		</td>
        <?php 	if(str_replace("  ","",$result['XGambarJawab2'])==''){
				} else {$gambarB = "XGambarJawab".$result['XB']; $pilgbrB = "$result[$gambarB]";		
				...
				<div class="modal-dialog" style="width:95%">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<div class="inner-content">
								<div class="row" style="background-color:#fff">
									<?php 	if(str_replace("  ","",$pilgbrB)==''){}else{
        ...
        <td class="pilihanjawaban" valign="top"><?php echo "$jwbB"; ?></td>
	</tr>
	<tr><td valign="top"><input id="C" type="radio" name="credit-card" value="C" <?php echo $nilaiC; ?>>
			<label class="drinkcard-cc C" for="C">&nbsp;</label></td>
				<?php 	if(str_replace("  ","",$result['XGambarJawab3'])==''){
						} else { $gambarC = "XGambarJawab".$result['XC']; $pilgbrC = "$result[$gambarC]";
				...
				<div class="modal-dialog" style="width:95%">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<div class="inner-content">
								<div class="row" style="background-color:#fff">
									<?php 	if(str_replace("  ","",$pilgbrC)==''){}else{
        ...
        <td class="pilihanjawaban" valign="top"><?php echo "$jwbC"; ?></td>
	</tr>
	<?php if($sopil>3){?>
	<tr><td valign="top"><input id="D" type="radio" name="credit-card" value="D" <?php echo $nilaiD; ?>>
		...
		$pilgbrD = "$result[$gambarD]";
		 echo "<td valign='top'><a href='#'  data-toggle='modal' data-target='#myModalD'><img src='./pictures/$pilgbrD' style='max-height:190px'></a></td>";} ?>
          <div class="modal fade" id="myModalD" role="dialog">
                ...
                <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h1 class="panel-title page-label">Perbesar Gambar D</h1>
                                </div>
                                <div class="panel-body">
                                    <div class="inner-content">
                                        <div class="row" style="background-color:#fff">
        ...
        <div class="panel panel-default">
                        <div class="panel-heading">
                            <h1 class="panel-title page-label">Perbesar Gambar E</h1>
                        </div>
                        <div class="panel-body">
                            <div class="inner-content">
                                <div class="row" style="background-color:#fff">
		...
		<div class="container1" style="margin-right:-100px; margin-left:-50px;">
			<div >
				 <?php 	if($prev_id>0){ 
					echo "<a href='#' data-id='".$prev_id."' class='get_pic' id='tombol'>"; } ?>
						<button id="btnPrevSoal" style="padding-bottom:10px; padding-top:10px; width:225px; border-radius: 30px; " class="btn btn-primary btn-prev" data-bind="click: gotoBack" >Soal Sebelumnya</button>
					</a>
			</div>
			<?php	if(isset($stu)){ 
						...
						if($sopil>3){ if(isset($XD)){ $nilaiD = $var_ragu['$XD']; }	}
						if($sopil>4){ if(isset($XE)){ $nilaiE = $var_ragu['$XE']; }	}
					}
			?>
			<div>	<label  class="labele" style="padding-bottom:10px; padding-top:10px; width:225px; border-radius: 30px;">
			...
			<div >
					...
					<?php 	$cekragu = mysql_num_rows(mysql_query("select * from cbt_jawaban where XRagu ='1' and XKodeSoal ='$xkodesoal' and XTokenUjian = '$xtokenujian'  and XUserJawab = '$user'")); 
							if($cekragu>0){ ?>
							<button id="btnSelesai" style="padding-bottom:10px; padding-top:10px; width:225px; border-radius: 30px;" class="btn btn-primary btn-end activebutton" data-toggle="modal" data-target="#myModalR">TES SELESAI</button>
					<?php 	} else { ?>  
							<button id="btnSelesai" style="padding-bottom:10px; padding-top:10px; width:225px; border-radius: 30px;" class="btn btn-primary btn-end activebutton" data-toggle="modal" data-target="#myModal2">TES SELESAI</button>
					<?php 	} echo "</a>";
								...
								<button id="btnNextSoal" class="btn btn-primary btn-next activebutton" data-bind="css: { &#39;activebutton&#39;:(currentNo() &lt; totalQuestions - 1)}, visible: (currentNo() &lt; 
									totalQuestions - 1),click: gotoNext" style="margin-top:-13px; width:225px; border-radius: 30px;">Soal Selanjutnya</button>
					<?php  	} ?>
					<?php 	} else { ?>
			 		<?php	$cekragu = mysql_num_rows(mysql_query("select * from cbt_jawaban where XRagu ='1' and XKodeSoal ='$xkodesoal' and XTokenUjian = '$xtokenujian'  and XUserJawab = '$user'")); 
							if($cekragu>0){ ?>
...
<style>
	.labele { display: block; padding-top:6px; padding-bottom:6px; font-size: 16px; background-color: #eaca08; margin-top:-10px; padding-left:50px;
			border-radius: 2px; cursor:pointer; width:210px; color:#FFF;  
			&:hover { cursor: pointer;}
			input[type="checkbox"] { position: relative; top: 3px; font-size:18px; border: 2px solid black; width: 20px; height: 20px; margin: 0; padding: 0;}}
</style>
    ...
    <div class="modal-dialog">
		<div class="panel panel-default">
			...
			<div class="panel-footer">
				<div class="row" style="background-color:#fff">
					<div class="col-xs-6"> 
						<button id="btnLanjut" type="submit" class="btn btn-primary btn-block" disabled onClick="location.href='akhir.php';"  style="border-radius: 30px;">SELESAI</button>
					</div>
					<div class="col-xs-6" >
						<button type="submit" class="btn btn-danger btn-block " data-dismiss="modal" style="border-radius: 30px;">TIDAK</button>
					</div>
				</div>
			</div>
		...
		<div class="panel panel-default">
                ...
                <div class="panel-footer">
                    <div class="row" style="background-color:#fff">
                        ...
                        <div class="col-xs-6 col-center" style="margin-left:25%; border-radius: 30px;" >
                ...
                <div class="panel-footer">
                    <div class="row"  style="background-color:#fff">
                        <div class="col-xs-offset-3 col-xs-6">
                            <button id="btnLanjut" data-bind="click: redirectToDone" type="submit" class="btn btn-success btn-block" disabled=""  style="border-radius: 30px;">SELESAI</button>
                        </div>
                    </div>
                </div>
            </div>
