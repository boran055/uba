        ...
        <div class="panel panel-default">
                        ...
                        <div class="panel-footer">
                            <div class="row" style="background-color:#fff">
                                ...
                                <div class="col-xs-6 col-center" style="margin-left:25%">
                                    <button data-bind="click: handleNotConfirm" type="submit" class="btn btn-danger btn-block"  data-dismiss="modal" id="lanjut" style="border-radius: 30px;">Tutup</button></a>
                                </div>
                            </div>
                        </div>
...
<div class="container1" style="margin-left:-30px;">
	 ...
	 ?>
                    <button id="btnPrevSoal" class="btn btn-primary btn-prev" data-bind="click: gotoBack" style="border-radius: 30px;">SOAL SEBELUMNYA</button>
      </a>
     </div>
     <?php
...
if(isset($stu)){ 
 ...
 if(isset($XE)){ $nilaiE = $var_ragu['$XE']; }
   ...
   ?>
    ...
    <div style="border-radius: 30px;"><label  class="labele" style="padding-bottom:10px; padding-top:10px; width:225px">
    ...
    <div >
				   ...
				   and XUserJawab = '$user'")); 
 					  	if($cekragu>0){ ?>
						<button id="btnSelesai" class="btn btn-primary btn-end activebutton" data-toggle="modal" data-target="#myModalR" style="border-radius: 30px;">TES SELESAI</button>
                      	<?php } else { ?>  
						<button id="btnSelesai" class="btn btn-primary btn-end activebutton" data-toggle="modal" data-target="#myModal2" style="border-radius: 30px;">TES SELESAI</button>
                    	<?php } //echo "|$next_id|";
					echo "</a>";
					} else { 
...
data-bind="css: { &#39;activebutton&#39;:(currentNo() &lt; totalQuestions - 1)}, visible: (currentNo() &lt; totalQuestions - 1),click: gotoNext" style="margin-top:-13px; width:225px; border-radius: 30px;">SOAL BERIKUTNYA</button><?php // echo "|$next_id|"; 
