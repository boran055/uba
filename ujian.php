...
<!-- <script type="text/javascript" src="css/js/jquery.js"></script> !-->
 <script src="css/js/jquery-scrolltofixed.js" type="text/javascript"></script>
...
<meta charset="utf-8">
        ...
        <link href="mesin/css/bootstrap.min.css" rel="stylesheet">
...
<script src="css/js/inline.js"></script>
...
<header class="masthead">
    ...
    <tr>
        ...
        <td width="10%" >
            <span class="user"><font color="white"><b><?php echo "$val_siswa"; ?></b></font></span>
            <br>
                    ...
                    <div class="col-md-12">
                        <div class="content">
                          ...
                          <?php } ?>
                          	    <li class="header">
                                     ...
                                     <span class="flex-putih">SOAL NO. </span>
                                                      <span class="flex-item"  id="soal"></span>
                                                      <!--<span class="flex-biru"> Daftar Soal</span>-->
                                                      <div class="flex-abu">Sisa Waktu <span id="h_timer" ></span>  </div> 
                                  </li>
                          ...
                          <span id="hurufsoal"> Ukuran font soal : <a id="jfontsize-m2" href="#" style="font-size:16px; text-decoration:none">&nbsp; A &nbsp;</a> <a id="jfontsize-d2" href="#" style="font-size:18px; text-decoration:none">&nbsp; A &nbsp;</a> <a id="jfontsize-p2" href="#" style="font-size:24px; text-decoration:none">&nbsp; A &nbsp;</a></span></div>   
                                              ...
                                              <script type="text/javascript" src="css/js/jquery-2.0.3.js"></script>
                                              <script type="text/javascript" src="css/js/jquery.countdownTimer.js"></script>  
...
<script src="css/js/cookieList.js"></script>
<script src="css/js/backend.js"></script>
                ...
                <div class="panel-footer">
                    <div class="row" style="background-color:#fff">
                        <div class="col-xs-offset-3 col-xs-6">
                            <button type="submit" class="btn btn-success" data-dismiss="modal" style="border-radius: 30px;">SELESAI</button>
                            <button type="submit" class="btn btn-danger" data-dismiss="modal" style="border-radius: 30px;">TIDAK</button>                            
                        </div>
                    </div>
                </div>
            </div>
